    ...
    <section>
        ...
        <form action="editarPost.jsp" method="POST" >
            ...
            <div>
                ...
                <input class="form-control mb-4" type="text" id="titulo" name="titulo" placeholder="Digite o título do post" required maxlength="255" value=<%out.write("'"+post.getTitulo()+"'");%>/>
            </div>
            <div class="mt-3">
